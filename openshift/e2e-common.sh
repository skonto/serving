...
#     git clone --depth 1 https://github.com/skonto/serverless-operator.git ${SERVERLESS_DIR}
#  fi
  git clone -b test_revert --depth 1 https://github.com/skonto/serverless-operator.git ${SERVERLESS_DIR}
