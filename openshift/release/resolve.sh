...
function resolve_file() {
  ...
  sed -e "s+serving.knative.dev/release: devel+serving.knative.dev/release: \"knative-v1.0.1\"+" \
      -e "s+app.kubernetes.io/version: devel+app.kubernetes.io/version: \"knative-v1.0.1\"+" \
      "$file" >> "$to"
}
